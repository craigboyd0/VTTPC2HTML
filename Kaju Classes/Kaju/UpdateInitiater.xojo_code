		...
		Private Sub RunScriptLinux(tempFolder As FolderItem, pid As FolderItem)
		  ...
		  if scriptFile <> nil then
		    ...
		    while Ticks < targetTicks
		      sh.Poll
		      Thread.YieldToNext
		      // App.YieldToNextThread <-- Deprecated use Thread.YieldToNext 
		    wend
		...
		Private Sub RunScriptMac(tempFolder As FolderItem, pid As FolderItem)
		  ...
		  if scriptFile <> nil then
		    ...
		    while Ticks < targetTicks
		      sh.Poll
		      Thread.YieldToNext
		      // App.YieldToNextThread  <-- Commented out and replaced with Thread.YieldToNext for API 2
		    wend
		...
		Private Sub RunScriptWindows(tempFolder As FolderItem, pid As FolderItem)
		  ...
		  if scriptFile <> nil then
		    ...
		    While Ticks < targetTicks
		      ...
		      // App.YieldToNextThread <-- done for API 2 
		      Thread.YieldToNext
